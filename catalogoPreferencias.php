...
<div class="container-fluid row">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btnGuardar'])) {
        ...
        $sql = $conexion->prepare("INSERT INTO catalogopreferencias (codigo, nombre, descripcion, cantidad, estado, fecha, oferta, codigoBarras) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        $sql->bind_param("sssissds", $codigo, $nombre, $descripcion, $cantidad, $estado, $fecha, $oferta, $codigoBarras);
    ...
    <?php
    $sql = $conexion->query("SELECT id, codigo, nombre, descripcion, cantidad, estado, fecha, oferta, codigoBarras FROM catalogopreferencias");
    ?>
